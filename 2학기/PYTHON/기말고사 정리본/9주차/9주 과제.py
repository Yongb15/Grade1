...
for i in range(1, num1+1):                              # num1의 약수를 구하는 식
    if num1 % i == 0:
        num1_l.append(i)

for i in range(1, num2+1):                              # num2의 약수를 구하는 식
    if num2 % i == 0:
        num2_l.append(i)

for i in range(len(num1_l)):                            
    if num1_l[i] in num2_l:                             # in을 통해 num1_l에 있는 값들이 num2_l에 있나 확인하는 코드
        num3_l.append(num1_l[i])                        # 있으면 num3_l에 넣어줌

print("{}와 {}의 공약수는".format(num1, num2))
print("{}".format(num3_l))
'''
